...
class Calendar:
    ...
    def addTask(self):
        ...
        # absolute = input("Is the task delayable? (True/False): ")
        # absolute = True if absolute == "True" else False
    ...
    def printCalendar(self):
        ...
        def get_skin_tone_color(task_count):
        ...
        for month in range(12):
            for day in range(31):
                ...
                if tasks:
                    ...
                    color = get_skin_tone_color(task_count)
